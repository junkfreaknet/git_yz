...
public class CopyOfPrintStandardSheetB4FromDB {

	public CopyOfPrintStandardSheetB4FromDB(mycommons.print.Printer printer,mycommons.db.connection.ParaConnection paraConnection,mycommons.db.SQLString sql){
